    ...
    const scrapeUrl = useCallback(async (targetUrl: string, silent = false) => {
        try {
            ...
            const categoryMappings: Record<string, string[]> = {
                'Pain Relief': ['pain', 'analgesic', 'antipyretic', 'fever', 'headache', 'paracetamol', 'ace', 'napa', 'diclofenac', 'ibuprofen', 'naproxen', 'ketorolac', 'etoricoxib', 'tramadol', 'aspirin', 'acemetacin', 'tendonil'],
                'Diabetes': ['diabetes', 'insulin', 'sugar', 'metformin', 'glimepiride', 'diabetic', 'sitagliptin', 'vildagliptin', 'linagliptin', 'gliclazide', 'qmax', 'diamicron', 'combitrol'],
                'Blood Pressure': ['blood pressure', 'hypertension', 'amlodipine', 'losartan', 'atenolol', 'hypertensive', 'propranolol', 'beta-blocker', 'bisoprolol', 'carvedilol', 'nifedipine', 'enalapril', 'ramipril', 'valsartan', 'telmisartan', 'olmesartan', 'irbesartan'],
                'Baby Care': ['baby', 'infant', 'pediatric', 'kid', 'child', 'gripe water', 'nappy', 'diaper', 'lactogen', 'cerelac'],
                'Vitamins & Supplements': ['vitamin', 'supplement', 'multivitamin', 'calcium', 'zinc', 'omega', 'iron', 'cod liver', 'b12', 'folic acid', 'bexovital', 'polyvit'],
                'Heart Health': ['heart', 'cardiac', 'cholesterol', 'statin', 'atorvastatin', 'rosuvastatin', 'propranolol', 'beta-blocker', 'nitroglycerin', 'digoxin', 'warfarin', 'clopidogrel', 'aspirin', 'clopid'],
                'Gastric & Ulcer': ['gastric', 'ulcer', 'acidity', 'omeprazole', 'esomeprazole', 'pantoprazole', 'antacid', 'famotidine', 'domperidone', 'sucralfate', 'rabeprazole', 'gelusil', 'entacyd'],
                'Antibiotic': ['antibiotic', 'infection', 'bacterial', 'azithromycin', 'cefixime', 'amoxicillin', 'ciprofloxacin', 'flucloxacillin', 'ceftriaxone', 'moxifloxacin', 'metronidazole', 'zithrox', 'furocef'],
                'Eye & ENT': ['eye drop', 'ear drop', 'nasal', 'otitis', 'conjunctivitis', 'visine', 'napa nasal'],
                'Skin Care': ['skin', 'ointment', 'cream', 'fungal', 'scabies', 'parasiticide', 'monosulfiram', 'betamethasone', 'clotrimazole', 'miconazole', 'permethrin', 'savlon', 'dettol'],
                'Tablet': ['tablet', 'tab'],
                'Capsule': ['capsule', 'cap'],
