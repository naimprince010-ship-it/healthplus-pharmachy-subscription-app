...
export default function EditCouponPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const fetchCoupon = async () => {
    try {
      const res = await fetch(`/api/admin/discount/coupons/${id}`)
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600">Update the coupon settings</p>
      </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                type="text"
                value={formData.code}
                className="w-full rounded-lg border bg-gray-100 px-3 py-2 font-mono uppercase"
                disabled
              />
